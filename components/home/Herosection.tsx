...
export const HeroSection = () => {
  return (
    <>
      <section className="py-14 md:py-28 flex flex-col items-center justify-center bg-white dark:bg-primary text-[#6B7B8F]">
        <h1 className="text-center text-balance md:leading-[68px] text-4xl md:text-[64px] font-bold text-purple-950 dark:text-white pb-6">
          Welcome to Traverse - Your <br />
          Ultimate Time Tracking <br /> Companion!
        </h1>
        <p className="text-center md:text-lg text-sm text-primary dark:text-white md:w-[42%] pb-9">
