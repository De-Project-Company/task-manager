    ...
    <div className="md:flex items-center py-14 md:px-16 px-5 md:py-28">
      <section>
        ...
        <p className="font-normal text-neutraly text-balance text-sm md:text-lg md:w-[80%] pb-6">
          At Traverse, we envision a world where individuals and teams
          effortlessly navigate their workdays, armed with precise time tracking
          and insightful productivity analytics. Our goal is to empower users to
          make informed decisions, fostering a more efficient and fulfilling
          work experience.
        </p>
      </section>
