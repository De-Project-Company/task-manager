...
Thank you for considering contributing to Traverse! We welcome all kinds of contributions, including bug reports, feature requests, and code improvements.
...
2. Clone your forked repository:
   ```sh
   git clone https://github.com/De-Project-Company/task-manager
   ```
...
If you find a bug, please open an issue on [GitHub Issues](https://github.com/De-Project-Company/task-manager/issues) and include as much detail as possible. Provide steps to reproduce, expected and actual behavior, and any relevant logs.

### Suggesting Features

If you have an idea for a new feature, please open an issue on [GitHub Issues](https://github.com/De-Project-Company/task-manager/issues) and describe your proposal. Explain why the feature would be useful and how it should work.
